...
//         this.amount = 0;
//         this.price = 0;
//         this.ingredients = new List<InventoryItem>();
//         this.ingredients.Add(new InventoryItem());
//     }
//     public Recipe(
//         string itemID, int amount, int price, string ingredient1ItemID, 
//         int ingredient1amount, string ingredient2ItemID, int ingredient2amount)
...
//         this.price = price;
//         this.ingredients = new List<InventoryItem>();
//         this.ingredients.Add(new InventoryItem(ingredient1ItemID, ingredient1amount));
//         this.ingredients.Add(new InventoryItem(ingredient2ItemID, ingredient2amount));
//     }
//     public Recipe(
//         string itemID, int amount, int price, string ingredient1ItemID, 
//         int ingredient1amount, string ingredient2ItemID, int ingredient2amount, string ingredient3ItemID, int ingredient3amount)
